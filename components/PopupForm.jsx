        ...
        <div className="grid grid-cols-1 max-xl:gap-12 xl:grid-cols-12 ">
          ...
          <div className="order-1 xl:order-2 max-xl  xl:col-span-4 xl:pl-10 border-l border-gray-200 flex items-center">
            ...
            <div className="max-w-full max-xl:py-6 max-md:px-5 xl:w-[400px] mx-auto">
              ...
              <div className="mt-5 w-full text-[#646664] max-w-[460px] text-xs leading-relaxed text-darkGrayNew md:text-sm">
                New accounts are subject to our&nbsp;
                <span className="   ">Terms</span>
                &nbsp;and&nbsp;
                <span className="  ">Privacy Policy</span>.
              </div>
              <div className="mt-8 flex w-full max-w-[460px] flex-col items-start justify-start gap-2 text-[13px] font-bold leading-5 tracking-wide text-[#646664]">
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <defs>
                      ...
                      >
                        <stop stopColor="#00B060"></stop>
                        <stop offset="1" stopColor="#009753"></stop>
                      </linearGradient>
                    </defs>
                  </svg>
